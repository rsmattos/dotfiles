...
def plot_nuclear_populations(ntraj, labels, markers):
    ...
    plt.plot(qm_time, N[:, 0],
                 markersize=3, markevery=15,
                 label='total pop')
...
an.fill_nuclear_bf_populations("nuclear_population.dat")
...
plot_nuclear_populations(ntraj, an.datasets["labels"], markers)
